...
// Legacy helper retained for Sheet row identity matching. Project-domain uniqueness
// itself uses exact host normalization in normalize_project_domain()/extractHost().
